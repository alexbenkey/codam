...
{ 
    ...
    std::cout << "ScavTrap with name: " << this->_name << " was created." << std::endl;
    std::cout << "it has: " 
    << get_hp() << " hp" << std::endl                        
...
ScavTrap::ScavTrap(std::string const name, ScavTrap const &rhs) : ClapTrap(name){
    set_hp(rhs._hp);
    set_ep(rhs._ep);
    set_ad(rhs._ad);
    std::cout << "ScavTrap with name: " << this->_name << " was created." << std::endl;
...
{
    std::cout << "ScavTrap with name: " << this->_name << " was destroyed" << std::endl;
}
